...
var FINDINGS = [
  ...
  { id: "shimcache-4", category: "EXECUTION", severity: "MEDIUM", confidence: 0.8, title: "Ejecución registrada de un programa con nombre sospechoso", artifact: W("C:/Users/jugador/AppData/Local/Packages/Microsoft.WindowsStore_8wekyb3d8bbwe/LocalCache/Roaming/herramientas/varias/nombre/CHEAT_LOADER_FINAL.exe"), evidence: JSON.stringify({ path: W("C:/Users/jugador/AppData/Local/Packages/Microsoft.WindowsStore_8wekyb3d8bbwe/LocalCache/Roaming/herramientas/varias/nombre/CHEAT_LOADER_FINAL.exe") }) },
  { id: "usn-9", category: "EXECUTION", severity: "LOW", confidence: 0.3, title: "Actividad sobre un archivo con nombre sospechoso", artifact: W("C:/Users/x/Desktop/cheat") + String.fromCharCode(0x202E) + "fdp.exe", timestamp: iso(5), evidence: JSON.stringify({ FileName: "cheat" + String.fromCharCode(0x202E) + "fdp.exe" }) },
